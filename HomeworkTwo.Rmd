---
title: "Homework 2"
author: "Seyfaddin Gandil 21080647"
output: pdf_document
---
...
```{r}
start_date <- as.POSIXlt("2023-01-01 00:00:00", tz = "UTC")
end_date <- as.POSIXlt("2023-02-01 00:00:00", tz = "UTC")
diff_minutes <- difftime(end_date, start_date, units = "mins")
(diff_minutes)
```
